...
@Slf4j
@Profile("oracle")
public class SqlOracleConfig {
  @Value("classpath:/db/queries/oracle/user-queries.xml")
  Resource userSqlFile;

  @Value("classpath:/db/queries/oracle/trade-queries.xml")
  Resource tradeSqlFile;
  @Value("classpath:/db/queries/oracle/chart-queries.xml")
  Resource chartSqlFile;
  @Value("classpath:/db/queries/oracle/stocks-queries.xml")
  Resource stockSqlFile;

  @Value("classpath:/db/queries/oracle/refdata-queries.xml")
  ...
  private Properties load(Resource resource) throws IOException {
    ...
    log.debug("Oracle Sql Props loaded: {}", properties.stringPropertyNames());
    return properties;
  }
}
