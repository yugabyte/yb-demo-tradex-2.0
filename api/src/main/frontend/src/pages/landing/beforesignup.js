        ...
        <div className={classes.landingHeader}>
              ...
              <Grid container spacing={2} >
                  ...
                  <Grid item xs={12} sx={{my:6}}>
                    <Typography variant="h1" component="h2" sx={{fontWeight:600}}>Let's you in </Typography>
                  </Grid> 
              </Grid>
              ...
              <Box sx={{marginTop:"40px !important"}}>
                <Grid container spacing={2}>  
                    <Grid item xs={12}>
                            <Button variant="outlined" sx={{width:300,borderRadius:2,backgroundColor:"#ECE7FE",border:"none"}}> 
                              <svg width="36px" height="44px" viewBox="0 0 64 64" version="1.1" sx={{paddingRight:"8px"}}>
                               ...
                               <Typography sx={{lineHeight:"3.5em !important",color:"#000 !important",fontSize:"12px !important"}}> &nbsp;Continue with Facebook </Typography>
                            </Button>

                            <Button variant="outlined" sx={{width:300,borderRadius:2,backgroundColor:"#E3F4E1",border:"none",mt:1}}> 
                              <svg width="32px" height="40px" viewBox="0 0 64 64" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                              ...
                              <Typography sx={{lineHeight:"3.5em !important",color:"#000 !important",fontSize:"12px !important"}}> &nbsp;Continue with Google </Typography>
                            </Button>

                          
                            <Button variant="outlined" sx={{width:300,borderRadius:2,backgroundColor:"#EBF0F0",border:"none",mt:1}}> 
                              <span sx={{marginLeft:"-30px !important"}}>
                                <svg width="36px" height="40px" viewBox="0 0 64 64" version="1.1" sx={{marginLeft:"-30px"}}>
                                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                              ...
                              <Typography sx={{lineHeight:"3.5em !important",color:"#000 !important",fontSize:"12px !important"}}> &nbsp;Continue with Apple </Typography>
                            </Button>               
                    </Grid>
                </Grid>
              </Box>
            ...
            <Box sx={{marginTop:"100px !important"}} >
                <Grid container spacing={2} > 
                  ...
                  <Grid item xs={12}>    
                    <Button variant="contained" color="success" onClick={() => {navigate("/dashboard");}} sx={{width:270,borderRadius:3}}>
                      SIGN IN
                    </Button> 
                  </Grid>
                  ...
                  <Grid item xs={12}>
                    <Typography>
                      ...
                      <Link to={``} sx={{textDecoration:"none"}}>&nbsp; Sign Up</Link>
                    </Typography>
                  </Grid>
                </Grid>
            </Box>
