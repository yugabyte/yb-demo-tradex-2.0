    ...
    <div className="page-header">
     ...
     <Box>
        ...
        <Grid item xs={12} sx={{m:5}}>
          <Stack direction="column" justifyContent="center" alignItems="center">
              <Typography variant="h6" component="h2" sx={{fontWeight:600,textAlign:"center"}}>Congratulations! </Typography>    
          </Stack>
          <Stack direction="column" justifyContent="center" alignItems="center" sx={{textAlign:"center",mt:1}}>
              <Typography variant="p" sx={{fontSize:"12px !important",fontWeight:300,textAlign:"center !important",marginLeft:"12px"}}>Your account is ready to use. You will be redirected to the home page in a few seconds. </Typography>
          </Stack>
        </Grid>

        <Grid item xs={12} sx={{mx:5,mt:25}}>
          <Button variant="outlined" color="success" onClick={() => {navigate("/login");}} sx={{color:"#000",backgroundColor:"#eee",border:"1px solid #D9D9D9",width:300,borderRadius:1,marginTop:"70px"}}>
              Back to Home
          </Button>
        </Grid>
