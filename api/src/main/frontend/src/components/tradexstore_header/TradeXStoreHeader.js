...
import { ReactComponent as BookstoreTextLogo } from "../../assets/tradesvg.svg";
...
export default function TradeXStoreHeader(props) {
  const { count } = props;
  ...
  return (
    <div className={classes.tradeXTitleLogo}>
      <Link to="/login" className={classes.bookstoreHeading}>
        <BookstoreTextLogo />
      </Link>
      <Link to="/exch">
